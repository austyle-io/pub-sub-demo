...
export function canUserEditDocument(doc: Document, userId: string, userRole: string): boolean {
...
export function canUserViewDocument(doc: Document, userId: string, userRole: string): boolean {
