 ...
 * ```
 */
export declare function isJwtPayload(value: unknown): value is JwtPayload;
/**
 ...
 * ```
 */
export declare function isApiError(value: unknown): value is {
  error: string;
  details?: unknown;
};
/**
 ...
 * ```
 */
export declare function isAuthResponse(value: unknown): value is AuthResponse;
/**
 ...
 * ```
 */
export declare const isValidUser: (obj: unknown) => obj is User;
/**
 ...
 * ```
 */
export declare function isCreateUserRequest(
  value: unknown,
 ...
 * ```
 */
export declare function isLoginRequest(value: unknown): value is LoginRequest;
/**
 ...
 * ```
 */
export declare function isRefreshTokenRequest(
  value: unknown,
