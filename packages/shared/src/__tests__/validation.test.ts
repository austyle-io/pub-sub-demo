...
import type { Document, CreateDocumentRequest } from '../index'
...
describe('Schema Validation', () => {
  ...
  describe('CreateDocumentRequest Schema', () => {
    ...
    it('should reject request without title', () => {
      ...
      expect(validateCreateDocumentRequest(invalidRequest)).toBe(false)
    })
  })
  ...
  describe('validateOrThrow', () => {
    ...
    it('should throw when invalid', () => {
      ...
      expect(() => {
        validateOrThrow(data, validateCreateDocumentRequest, 'Invalid request')
